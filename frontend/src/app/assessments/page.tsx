      ...
      <main className="app-main-layout" style={{ padding: "24px 20px", maxWidth: 1100, overflow: "auto" }}>
        ...
        {activeTab === "phq9" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            {phq9Comparison && phq9Comparison.previous && (
              <div
                style={{
                  padding: 16,
                  borderRadius: 16,
              ...
              >
                ...
                <div
                  style={{
                    fontSize: 14,
                    fontWeight: 800,
                    color: phq9Comparison.improved ? "#22c55e" : "#ef4444",
                  }}
                >
                  {phq9Comparison.improved ? "📉 Improved (-" + Math.abs(phq9Comparison.score_delta) + " pts)" : phq9Comparison.same ? "⚖️ Stable" : "📈 Increase (+" + phq9Comparison.score_delta + " pts)"}
                </div>
              </div>
            )}
        ...
        {activeTab === "gad7" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            {gad7Comparison && gad7Comparison.previous && (
              <div
                style={{
                  padding: 16,
                  borderRadius: 16,
              ...
              >
                ...
                <div
                  style={{
                    fontSize: 14,
                    fontWeight: 800,
                    color: gad7Comparison.improved ? "#22c55e" : "#ef4444",
                  }}
                >
                  {gad7Comparison.improved ? "📉 Reduced Anxiety (-" + Math.abs(gad7Comparison.score_delta) + " pts)" : gad7Comparison.same ? "⚖️ Stable" : "📈 Increase (+" + gad7Comparison.score_delta + " pts)"}
                </div>
              </div>
            )}
